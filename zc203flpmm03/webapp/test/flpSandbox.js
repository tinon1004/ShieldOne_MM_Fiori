		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[ShieldOne-MM] 자재 구매 계획 조회 및 결재 ",
									"targetURL": "#zc203zc203flpmm03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc203zc203flpmm03-display": {
								"semanticObject": "zc203zc203flpmm03",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc203.zc203flpmm03",
									"url": sap.ui.require.toUrl("zc203/zc203flpmm03")
								}
							}
						}
					}
