		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[ShieldOne-MM] 재고 현황 및 납기일 조회",
									"targetURL": "#zc203zc203flpmm04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc203zc203flpmm04-display": {
								"semanticObject": "zc203zc203flpmm04",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc203.zc203flpmm04",
									"url": sap.ui.require.toUrl("zc203/zc203flpmm04")
								}
							}
						}
					}
